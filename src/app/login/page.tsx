...
const Login = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
        ...
        <p className='text-gray-600 mb-8 flex items-center'>Login to Snapcart<Leaf className='w-5 h-5 text-green-500'/></p>
        <motion.form
        ...
        <div className='relative'>
...

            {
                (()=>{
                    ...
                    return <button type='submit' disabled={!formValidation || loading} className={`w-full font-semibold py-3 rounded-xl transition-all duration-200 shadow-md inline-flex items-center justify-center gap-2 ${
                        formValidation
