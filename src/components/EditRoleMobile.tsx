...
import { ArrowBigRight, Bike, User, UserCog } from 'lucide-react'
import axios from 'axios'
import { redirect } from 'next/navigation'
import { useRouter } from 'next/navigation'
//if user is inside, do not have given mobile number and it have not choosed its role yet(user,delivery boy)
...
const EditRoleMobile = () => {
  ...
  return (
    <div className='flex flex-col items-center min-h-screen p-6 w-full bg-linear-to-b from-green-100 to-white'>
      <motion.h1
      initial={{
            opacity:0,
            y:-20
