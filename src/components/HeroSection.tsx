'use client'
import { Leaf, PhoneCall, ShoppingBasket, Smartphone, Truck } from 'lucide-react'
    ...
    const slides = [
        {
            ...
            btnText: "Shop Now",
            bg: "https://images.unsplash.com/photo-1538826051293-02b4da7acc5f?q=80&w=1180&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
            id: 2,
        ...
        {
            id: 3,
            icon: <PhoneCall className='w-20 h-20 sm:w-28 sm:h-28 text-blue-400 drop-shadow-lg'/>,
            title: "Shop Anytime Anywhere 📱 ",
            subtitle: "Easy and seamless online groceries reach your doorstep in no time.",
            btnText: "Get Started",
            bg: "https://plus.unsplash.com/premium_photo-1661438206938-f2a4c5c105b2?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        }    
    ]
    ...
    <div className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl'>
        ...
        <div className='absolute inset-0 flex items-center justify-center text-center text-white px-6'>
            ...
            >
                ...
                <h1 className='text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight drop-shadow-lg'>{slides[current].title}</h1>
