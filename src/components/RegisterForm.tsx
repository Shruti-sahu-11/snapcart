...
import { ArrowLeft, Lock, Leaf, Mail, User, EyeOff, EyeIcon, LogIn } from 'lucide-react'
...
const RegisterForm = ({previousStep}: propType) => {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
        ...
        <p className='text-gray-600 mb-8 flex items-center'>Join Snapcart Today <Leaf className='w-5 h-5 text-green-500'/></p>
        <motion.form
        ...
        <div className='relative'>
...

            {
                (()=>{
                    ...
                    return <button type='submit' disabled={!formValidation} className={`w-full font-semibold py-3 rounded-xl transition-all duration-200 shadow-md inline-flex items-center justify-center gap-2 ${
                        formValidation
            ...
            <button type='button' className='w-full flex items-center justify-center gap-3 border border-gray-300 hover:bg-gray-50 py-3 rounded-xl text-gray-700 font-medium transition-all duration-200'>
